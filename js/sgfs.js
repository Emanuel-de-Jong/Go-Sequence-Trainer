    ...
    Reduction: {
        ...
        ShoulderHit: {
            ...
            ToSide: {
                ...
                Jump_Extend: [1, 4, "AB[fq][iq][oq][po][pn][ol]AW[co][dq][qp][qo][qm]PL[W];W[jp];B[jq];W[lp];B[kq];W[ln]C[Ladder doesn't work];B[kp]C[Attacker good];W[ko];B[jo];W[jn];B[io]"],
                Jump_Extend_Ladder: [1, 4, "AB[fq][iq][oq][po][pn]AW[co][dq][qp][qo][qm]PL[W];W[jp];B[jq];W[lp];B[kq];W[lm]C[Ladder works]"],
                Extend: [1, 3, "AB[fq][iq][oq][po][pn]AW[co][dq][qp][qo][qm]PL[W];W[jp];B[jq];W[kp];B[ip]LB[lr:A];W[jn];B[io]C[Attacker good];W[lm]"],
            },
            ToCenter: {
                Enabled: true,
                ...
                Extend_Extend: [1, 4, "AB[fq][iq][oq][po][pn]AW[co][dq][qp][qo][qm]PL[W];W[jp];B[ip];W[jo];B[io]C[Attacker good];W[jn];B[in];W[jm];B[];W[im]LB[jq:A]"],
            },
            Base: {
                Enabled: true,
                Cut: [1, 4, "AB[jq][pq][qo][qg][pd]AW[qm][qj]C[Attacker to make framework on lower right];B[pk];W[qk];B[pm];W[pn]C[Doesn't work];B[qn];W[pl];B[om]"],
                Extend: [1, 4, "AB[jq][pq][qo][qg][pd]AW[qm][qj]C[Attacker to make framework on lower right];B[pk];W[qk];B[pm];W[qn]C[Doesn't work];B[pn]"],
                Wedge: [1, 4, "AB[jq][pq][qo][qg][pd]AW[qm][qj]C[Attacker to make framework on lower right];B[pk];W[qk];B[pm];W[pl]C[Doesn't work];B[ol];W[ql];B[pn]"],
            },
        },
    },
    ...
    Daidaigeima: {
        ...
        Invasion: {
            ...
            Attach: {
                ...
                Wedge_AtariBottom_Right_Connect: [1, 10, "AB[fq][jp][op][pq]AW[dp][cn][qo][ql][qi]PL[W];W[hq];B[hp];W[ip]C[Ladders work];B[iq];W[io];B[hr];W[jq];B[gq];W[ir];B[hq]C[Attacker good];W[kp]"],
                Wedge_AtariTop: [1, 4, "AB[fq][jp][op][pq]AW[dp][cn][qo][ql][qi]PL[W];W[hq];B[hp];W[ip]C[Ladders work];B[io]C[Attacker good];W[iq];B[gp];W[jq];B[kp];W[kq];B[];W[];B[lp];W[mq];B[jn]LB[hn:A]"],
                ...
                Extend_Connect_Attach_React: [1, 7, "AB[fq][jp][op][pq][dk]AW[dp][cn][qo][ql][qi]PL[W]AE[dj];W[hq];B[hp];W[iq]C[One of the ladders doesn't work];B[ip];W[jq];B[dq];W[cq]C[Attacker is dead];B[kq];W[gq];B[gp];W[fr];B[er]"],
                Extend_Down: [1, 2, "AB[fq][jp][pq][po][pn][pm][ok]AW[dp][cn][rp][qn][qm][ql][qi]PL[W]AE[oj];W[hq];B[hp];W[iq]C[One of the ladders doesn't work];B[jq]C[Defender trades left for right side because of big framework];W[ip];B[io];W[gp];B[ho];W[gq];B[kn]LB[jo:A];W[];B[];W[go]C[F3 had aji]"],
            },
            ShoulderHit: {
                Enabled: true,
                Hane: [1, 4, "AB[fq][jp][op][pq]AW[dp][cn][qo][ql][qi]PL[W];W[hq];B[gp];W[jq];B[kq];W[kr]LB[kp:A]"],
                Ko: [1, 4, "AB[fq][jp][op][pq][ab][bc][bd][be][ae][cc][cb][ca]AW[dp][cn][qo][ql][qi][ac][af][bf][cf][ce][cd][dd][dc][db][da]PL[W];W[hq];B[gp];W[jq];B[kq];W[ip]C[Attacker has ko threat];B[jr];W[ir]"],
            },
        },
        Reduction: {
            Enabled: true,
        ...
        Enclosure: {
            ...
            C3_4: {
                ...
                Knight: {
                    ...
                    S16_ExtendDown: [1, 2, "AB[pq][qo][qp][qd][oc]AW[dd][dp][po][qn]PL[W];W[rd];B[qe];W[pm];B[nq];W[qi]C[Defender doesn't want to extend anymore];B[];W[qc];B[pc];W[qb];B[re];W[sc]"],
                    ...
                    S16_BottomHane_CrossCut_WallAtari: [1, 4, "AB[pq][qo][qp][qd][oc]AW[dd][dp][po][qn]PL[W];W[rd];B[re];W[qe];B[rc]C[Attacker good];W[pd];B[qc];W[rf];B[sd]C[Attacker shouldn't try to save upper right]"],
                    ...
                    S16_ExtendLeft: [1, 2, "AB[pq][qo][qp][qd][oc]AW[dd][dp][po][qn][mc]PL[W]C[Attacker good];W[rd];B[pd];W[re];B[rc];W[];B[];W[qh];B[];W[rb];B[sc];W[pb]"],
                ...
                LargeKnight: {
                    ...
                    O16_HaneLeft_Ko: [1, 2, "AB[qd][nc]PL[W]AW[dn];W[nd]C[Ladder works];B[md];W[oc];B[od];W[ne];B[pc];W[mc];B[ob];W[nb]C[Defender ko not enough threats];B[oc];W[ld];B[em];W[me]"],
                    ...
                    R17_Extend: [1, 2, "AB[qd][nc]PL[W];W[qc];B[pd];W[pc];B[oc];W[];B[];W[rd]C[Attacker must have enough ko threats];B[re];W[rb];B[sd];W[sc]"],
                ...
                OneSpace: {
                    ...
                    R15_Pincer: [1, 2, "AB[qd][od][jc]PL[W]AE[qj];W[qe];B[qg]C[Attacker good];W[qc];B[pd];W[rd];B[rc];W[rb];B[re];W[sc];B[rf];W[ob]"],
                    Q17_AttachLeft_Life: [1, 3, "AB[qd][od][qj][jc]PL[W];W[pc];B[oc];W[qc];B[pd];W[];B[];W[rd]C[Attacker must have enough ko threats];B[re];W[rb];B[sd];W[sc]"],
                ...
                TwoSpace: {
                    ...
                    Q16_Extend_Jump: [1, 7, "AB[qd][nd]PL[W]AW[dp];W[pd]C[Ladder good for attacker];B[pc];W[qc];B[oc];W[];B[];W[pf];B[rd];W[pi];B[];W[qe]"],
                    Q16_Extend_Atari_ExtendBottom_Atari: [1, 10, "AB[qd][nd]PL[W]AW[dp];W[pd]C[Ladder good for attacker];B[pc];W[qc];B[oc];W[];B[];W[rd];B[qe];W[re];B[qb];W[qf];B[rc];W[pe];B[qc];W[qi]"],
                    Q16_Extend_Atari_ExtendBottom_Extend: [1, 10, "AB[qd][nd]PL[W]AW[dp];W[pd]C[Ladder good for attacker];B[pc];W[qc];B[oc];W[];B[];W[rd];B[qe];W[re];B[qf]C[Attacker good];W[qb]"],
                    Q16_Extend_Atari_ExtendTop: [1, 9, "AB[qd][nd]PL[W]AW[dp];W[pd]C[Ladder good for attacker];B[pc];W[qc];B[oc];W[];B[];W[rd];B[qe];W[qb];B[re];W[sc]"],
        ...
        Corner: {
            ...
            C4_4: {
                ...
                Kick: {
                    ...
                    AttackerHighBase: {
                        Enabled: false,
                        H2_Attach_HaneConnect: [1, 3, "AB[dn][dp][eq]AW[fq][fp][jp]PL[B];B[hr];W[hq];B[fr];W[gr];B[gs];W[gq];B[dr]C[Corner is solid]"],
                        H2_Attach_HaneRight: [1, 3, "AB[dn][dp][eq]AW[fq][fp][jp]PL[B];B[hr];W[hq];B[iq];W[ip];B[gq];W[hp];B[fr];W[gp];B[gr]C[Corner has weaknesses]"],
                        H2_Kick: [1, 2, "AB[dn][dp][eq]AW[fq][fp][jp]PL[B];B[hr];W[gr]C[Attacker good];B[hp]LB[hn:A][kq:B]C[A and B are miai for attacker]"],
                    ...
                    AttackerLowBase: {
                        Enabled: true,
                        H3_AttachDown_HaneCorner: [1, 5, "AB[dn][dp][eq]AW[fq][fp][jq]AE[fo][ph];B[hq];W[hr];B[];W[];B[fr];W[gr];B[er];W[hp]"],
                        H3_AttachDown_HaneLeft: [1, 3, "AB[dn][dp][eq]AW[fq][fp][jq]AE[fo][ph];B[hq];W[hr];B[gr]C[Defender good];W[fr];B[ir];W[hp];B[iq];W[ip];B[jr];W[kq];B[hs]"],
                        H3_AttachDown_HaneRight: [1, 3, "AB[dn][dp][eq]AW[fq][fp][jq]AE[fo][ph];B[hq];W[hr];B[ir]C[Defender good];W[iq];B[gr];W[hp];B[hs];W[fr];B[jr];W[kq];B[kr]"],
                        H3_AttachUp_ExtendDown_ExtendRight: [1, 4, "AB[dn][dp][eq]AW[fq][fp][jq]AE[fo][ph];B[hq];W[hp];B[hr];W[ip];B[fr]"],
                        H3_AttachUp_ExtendDown_ExtendDown_Extend: [1, 4, "AB[dn][dp][eq]AW[fq][fp][jq]AE[fo][ph];B[hq];W[hp];B[hr];W[fr];B[ip];W[ho];B[jp];W[kp]LB[lq:A]"],
                        H3_AttachUp_ExtendDown_ExtendDown_Cut_Cut_Ladder: [1, 12, "AB[dn][dp][eq][ph]AW[fq][fp][jq]AE[fo];B[hq];W[hp];B[hr];W[fr];B[ip];W[iq];B[jp];W[kq];B[gp];W[ho];B[go];W[gq]C[Attacker good. Ladder works];B[hn]"],
                        H3_AttachUp_ExtendDown_ExtendDown_Cut_Cut_Net: [1, 16, "AB[dn][dp][eq]AW[fq][fp][jq][ph]AE[fo];B[hq];W[hp];B[hr];W[fr];B[ip];W[iq];B[jp];W[kq];B[kp];W[lq];B[lp];W[mq];B[gp];W[ho];B[go];W[gq]C[Attacker good. Net works];B[hn]"],
                        H3_AttachUp_ExtendDown_ExtendDown_Cut_Extend: [1, 16, "AB[dn][dp][eq]AW[fq][fp][jq][ph]AE[fo];B[hq];W[hp];B[hr];W[fr];B[ip];W[iq];B[jp];W[kq];B[kp];W[lq];B[lp];W[mq];B[gp];W[ho];B[go];W[hn];B[gq];W[cq]"],
                        H3_AttachUp_Bump: [1, 3, "AB[dn][dp][eq]AW[fq][fp][jq]PL[B]AE[jp];B[hq];W[hp];B[iq]C[Defender good];W[ip];B[jr];W[kq];B[kr];W[lq];B[lr];W[mq];B[gr];W[fr]"],
                        H3_Extend_ExtendUp_JumpRight: [1, 5, "AB[dn][dp][eq]AW[fq][fp][jq]AE[fo][ph];B[hq];W[fr];B[hp];W[fn];B[jp];W[kq];B[kp];W[lq];B[im]"],
                        H3_Extend_ExtendUp_JumpUp: [1, 5, "AB[dn][dp][eq]AW[fq][fp][jq]AE[fo][ph];B[hq];W[fr];B[hp];W[fn];B[hn];W[fl];B[];W[];B[mq]"],
                        H3_Extend_ExtendRight: [1, 3, "AB[dn][dp][eq]AW[fq][fp][jq]AE[fo][ph];B[hq];W[fr];B[iq];W[jp];B[ho];W[fn]"],
                        H3_ShoulderHit: [1, 2, "AB[dn][dp][eq]AW[fq][fp][jq]AE[fo][ph];B[hq];W[ip]C[Attacker good];B[hn];W[hp];B[];W[];B[fr];W[gr];B[er];W[hr]"],
